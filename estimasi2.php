    ...
    <main id="main">
      ...
      <section class="inner-page">
        ...
        <div class="kalkulator">
          ...
          <p class="judul">Shipping type : Plane</p>
          <form>			
          ...
          <a href="estimasi.php" class="tombolship2"target="_blank">Ship</a>
          <a href="estimasi2.php" class="tombolplane2"target="_blank">Plane</a>
          <!--
        ...
        <div class="desk">
          ...
          <p>For <i>Small (6 Feet)</i> Container we set a price at <b>17$</b><i class="bi bi-tag"></i></p>
          <p>For <i>Medium (10 Feet)</i> Container we set a price at <b>27$</b><i class="bi bi-tag"></i></p>
          <p>For <i>Large (20 Feet)</i> or <i>Big</i> Container we set a price at <b>32$</b><i class="bi bi-tag"></i></p>
          <p></p>
